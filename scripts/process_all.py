...
environments = [
    ...
    {"NAME": "python3.9-debian-10", "PYTHON_VERSION": "3.9"},
    {"NAME": "python3.9-prod", "PYTHON_VERSION": "3.9"},
    {"NAME": "python3.9-prod-debian-10", "PYTHON_VERSION": "3.9"},
    
    {"NAME": "python3.8", "PYTHON_VERSION": "3.8"},
    {"NAME": "python3.8-debian-10", "PYTHON_VERSION": "3.8"},
    {"NAME": "python3.8-prod", "PYTHON_VERSION": "3.8"},
    {"NAME": "python3.8-prod-debian-10", "PYTHON_VERSION": "3.8"},
    
    {"NAME": "python3.7", "PYTHON_VERSION": "3.7"},
    {"NAME": "python3.7-debian-10", "PYTHON_VERSION": "3.7"},
    {"NAME": "python3.7-prod", "PYTHON_VERSION": "3.7"},
    {"NAME": "python3.7-prod-debian-10", "PYTHON_VERSION": "3.7"},
]
